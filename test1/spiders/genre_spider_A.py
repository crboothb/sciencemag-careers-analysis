...
class QuotesSpider(scrapy.Spider):
    name = "genre_article_advice"

    def start_requests(self):
        urls_list = ["https://www.sciencemag.org/careers-career-article-genre/advice"]
        for i in range(150): #150
            urls_list.append("https://www.sciencemag.org/careers-career-article-genre/advice?page="+str(i))
